...
| [TRS 3.0 Primer](https://oslc-op.github.io/oslc-specs/notes/trs-guidance/trs-guidance.html) | This primer serves as a guide to the concepts in the TRS specification, and through the use of simple examples, explains how a data provider might expose resources in a TRS and how a TRS client might consume a data provider's TRS.  | David |
