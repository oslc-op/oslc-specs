...
public final class OSLC
{
	...
	public static final Resource	ResourceShapeConstraints	= resource("ResourceShapeConstraints");
	...
	public static final Property	accessContext				= ResourceFactory
		.createProperty("http://open-services.net/ns/core/acc#accessContext");
}
